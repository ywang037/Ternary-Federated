...
if __name__ == '__main__':
    ...
    if Args.save_record:
        ...
        record_path_save = f'../save_sea/{Args.fedmdl}/{Args.dataset}-{Args.model}-r{Args.rounds}-le{Args.local_e}-lb{Args.batch_size}-nc{Args.num_C}-lr{Args.lr}-' + time.strftime('%y-%m-%d-%H-%M-%S.csv')
